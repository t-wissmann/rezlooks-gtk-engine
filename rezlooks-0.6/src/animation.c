...
/* helper function for rezlooks_animation_connect_checkbox */
static gint
...
/* adds a progress bar */
void
rezlooks_animation_progressbar_add (GtkWidget *progressbar)
{
...
void
rezlooks_animation_connect_checkbox (GtkWidget *widget)
{
...
gboolean
rezlooks_animation_is_animated (GtkWidget *widget)
{
...
gdouble
rezlooks_animation_elapsed (gpointer data)
{
